  ...
  return (
    ...
    >
      <div className="px-4 max-w-7xl w-full mx-auto">
        ...
        <br />
        <p>
          Sistem kurikulum ketahfidzan, diniyyah, ekstrakurikuler, dan
          kepengasuhan teleh tersusun dan berjalan di seluruh kegiatan baik
          dalam pembelajaran maupun luar pembelajaran, sehingga mudah dalam
          memantau perkembangan , melakukan evaluasi, serta menghasilkan lulusan
          yang memenuhi standar kriteria yang telah ditetapkan oleh pesantren
        </p>
      </div>
    </section>
  );
